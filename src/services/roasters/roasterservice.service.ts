...
export class RoasterserviceService {
  ...
  getRolePermissions(roaster_id: any, roleid: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roaster_id + "/roles/" + roleid + "/permissions";
    data["token"] = this.cookieService.get("Auth");
    return this.http.post(this.url, data);
  }
  ...
  assignUserBasedUserRoles(roaster_id: any, role_id: any, user_id: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roaster_id + "/users/" + user_id + "/roles/" + role_id;
    data["token"] = this.cookieService.get("Auth");
    data["method"] = "POST";
    return this.http.post(this.url, data);
  }
  ...
  enableAdminUser(roaster_id: any, enableUserId: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roaster_id + "/users/" + enableUserId + "/enable";
    data["method"] = "PUT";
    data["token"] = this.cookieService.get("Auth");
  ...
  disableAdminUsers(roaster_id: any, disableUserId: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roaster_id + "/users/" + disableUserId + "/disable";
    data["method"] = "PUT";
    data["token"] = this.cookieService.get("Auth");
    return this.http.put(this.putUrl, data);
  }
  ...
  deleteRoasterContacts(roaster_id: any, contact_id: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roaster_id + "/users/top-contacts/" + contact_id;
    // data['method'] = "DELETE";
    data["token"] = this.cookieService.get("Auth");
    return this.http.post(this.deleteUrl, data);
  }
  ...
  shareFolder(roaster_id: any, file_id: any, body: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roaster_id + "/file-manager/" + file_id + "/share";
    data["token"] = this.cookieService.get("Auth");
    data["method"] = "POST";
    data["data"] = body;
    return this.http.post(this.url, data);
  ...
  getAgreements(roaster_id: any, customer_type: any) {
    ...
    var data = {};
    data["api_call"] =
      "/ro/" + roaster_id + "/" + customer_type + "/agreements";
    // data['params'] = params;
    data["token"] = this.cookieService.get("Auth");
    //  const params = new HttpParams().append( 'file_module', fileModule )
    console.log(data);
  ...
  getAgreementValue(roaster_id: any, customer_type: any, id: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roaster_id + "/" + customer_type + "/agreements/" + id;
    data["method"] = "GET";
    data["token"] = this.cookieService.get("Auth");
    return this.http.post(this.url, data);
  }
  ...
  getSharedUserList(roasterId: any, fileId: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roasterId + "/file-manager/" + fileId + "/shared-users";
    data["token"] = this.cookieService.get("Auth");
    data["method"] = "GET";
    return this.http.post(this.url, data);
  }
  ...
  unShareFolder(roaster_id: any, file_id: any, body: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roaster_id + "/file-manager/" + file_id + "/unshare";
    data["token"] = this.cookieService.get("Auth");
    data["method"] = "POST";
    data["data"] = body;
    return this.http.post(this.url, data);
  ...
  updatePermissions(roaster_id: any, file_id: any, body: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roaster_id + "/file-manager/" + file_id + "/permission";
    data["method"] = "PUT";
    data["token"] = this.cookieService.get("Auth");
    data["data"] = body;
    return this.http.post(this.url, data);
  ...
  getMicroRoasterStimulatedLogin(id: any, roasterId: any) {
    const data = {};
    data["api_call"] =
      "/ro/" + roasterId + "/micro-roasters/" + id + "/support-login";
    data["method"] = "POST";
    data["token"] = this.cookieService.get("Auth");
    return this.http.post(this.url, data);
  }
  ...
  getOrderDisputeList(roaster_id: any, order_id: any, orderType?) {
    ...
    if (orderType == "MR") {
      data["api_call"] =
        "/ro/" + roaster_id + "/mr-orders/" + order_id + "/disputes";
    }
    data["token"] = this.cookieService.get("Auth");
    return this.http.post(this.url, data);
  }
  ...
  addProductWeightVarients(
    ...
    data[
      "api_call"
    ] = `/ro/${roaster_id}/products/${product_id}/weight-variants`;
    data["token"] = this.cookieService.get("Auth");
    data["data"] = body;
    return this.http.post(this.url, data);
  }
  updateProductWeightVarients(
    roaster_id: any,
    product_id: any,
    body: any,
    weightVariantId: any
    ...
    data[
      "api_call"
    ] = `/ro/${roaster_id}/products/${product_id}/weight-variants/${weightVariantId}`;
    data["token"] = this.cookieService.get("Auth");
    data["data"] = body;
    return this.http.put(this.putUrl, data);
  }
  ...
  getProcuredCoffeeList(
    ...
    data["method"] = "GET";
    data["api_call"] = origin
      ? data["api_call"] + "?origin=" + origin
      : data["api_call"];
  ...
  CreateMarkForSale(roaster_id: any, orderID, data) {
    ...
    obj["method"] = "POST";
    obj["api_call"] =
      "/ro/" + roaster_id + "/procured-coffees/" + orderID + "/sale";
  ...
  updateMarkForSaleStatus(roaster_id: any, orderID, data) {
    ...
    obj["method"] = "PUT";
    obj["api_call"] =
      "/ro/" + roaster_id + "/procured-coffees/" + orderID + "/sale/status";
    obj["data"] = data;
    obj["token"] = this.cookieService.get("Auth");
    return this.http.post(this.url, obj);
  }
  ...
  raiseTicket(roaster_id: any, orderID, data, orderType?) {
    ...
    if (orderType && orderType == "MR") {
      obj["api_call"] =
        "/ro/" + roaster_id + "/mr-orders/" + orderID + "/disputes";
    }
    obj["token"] = this.cookieService.get("Auth");
    obj["data"] = data;
    return this.http.post(this.url, obj);
  ...
  markTicketasResolved(roasterId: any, disputeId: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roasterId + "/disputes/" + disputeId + "/resolve";
    data["token"] = this.cookieService.get("Auth");
    data["method"] = "PUT";
    return this.http.post(this.url, data);
  }
  ...
  escalteTicket(roasterId: any, disputeId: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roasterId + "/disputes/" + disputeId + "/escalate";
    data["token"] = this.cookieService.get("Auth");
    data["method"] = "PUT";
    return this.http.post(this.url, data);
  }
  ...
  assignUserDispute(roasterId: any, disputeId: any, userData) {
    var data = {};
    data["api_call"] =
      "/ro/" + roasterId + "/disputes/" + disputeId + "/assign";
    data["token"] = this.cookieService.get("Auth");
    data["data"] = userData;
    data["method"] = "POST";
    return this.http.post(this.url, data);
  ...
  listServiceCuppingReports(roaster_id: any, gc_order_id: any) {
    ...
    data[
      "api_call"
    ] = `​/gc/${roaster_id}​/orders/${gc_order_id}​/cupping-reports`;
    data["token"] = this.cookieService.get("Auth");
    data["method"] = "GET";
    return this.http.post(this.url, data);
  }
  ...
  addOrderNotes(roaster_id: any, order_id: any, orderData: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roaster_id + "/mr-orders/" + order_id + "/notes";
    data["token"] = this.cookieService.get("Auth");
    data["data"] = orderData;
    data["method"] = "POST";
    return this.http.post(this.url, data);
