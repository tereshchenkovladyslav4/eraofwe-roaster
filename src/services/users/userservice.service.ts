...
export class UserserviceService {
  ...
  getCertificates(roaster_id: any, userId: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roaster_id + "/users/" + userId + "/certificates";
    data["method"] = "GET";
    data["token"] = this.cookieService.get("Auth");
    return this.http.post(this.roasterUrl, data);
  }
  ...
  deleteProfileImage(userId: any, roasterId: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roasterId + "/users/" + userId + "/profile-image";
    data["token"] = this.cookieService.get("Auth");
    return this.http.post(this.roasterDeleteUrl, data);
  }
  ...
  async getLanguageStrings(language: any) {
    if (localStorage.getItem("languageStrings")) {
      return JSON.parse(
        decodeURIComponent(localStorage.getItem("languageStrings"))
      );
    } else {
      ...
      localStorage.setItem(
        "languageStrings",
        encodeURIComponent(JSON.stringify(languageJSON))
      );
      return languageJSON;
    }
  }
  ...
  getRoasterLotDetails(roaster_id: any, estate_id: any, lot_id: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roaster_id + "/estates/" + estate_id + "/lots/" + lot_id;
    data["method"] = "GET";
    data["token"] = this.cookieService.get("Auth");
    return this.http.post(this.roasterUrl, data);
  }
  ...
  getMicroDetails(roaster_id: any, micro_roaster_id: any) {
    ...
    var data = {};
    data["api_call"] =
      "/ro/" + roaster_id + "/micro-roasters/" + micro_roaster_id;
    data["method"] = "GET";
    data["token"] = this.cookieService.get("Auth");
    return this.http.post(this.roasterUrl, data);
  }
  ...
  updateMicroRoasterEnable(roaster_id: any, micro_roaster_id: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roaster_id + "/micro-roasters/" + micro_roaster_id + "/enable";
    data["token"] = this.cookieService.get("Auth");
    return this.http.put(this.putUrl, data);
  }
  updateMicroRoasterDisable(roaster_id: any, micro_roaster_id: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roaster_id + "/micro-roasters/" + micro_roaster_id + "/disable";
    data["token"] = this.cookieService.get("Auth");
    return this.http.put(this.putUrl, data);
  }
  ...
  getMicroroasterContacts(micro_roaster_id: any) {
    var data = {};
    data["api_call"] =
      "/general/mr/" + micro_roaster_id + "/users/top-contacts";
    data["method"] = "GET";
    data["token"] = this.cookieService.get("Auth");
    return this.http.post(this.roasterUrl, data);
  }
  ...
  getEstateGallery(estateId: any) {
    ...
    data[
      "api_call"
    ] = `/general/es/${estateId}/file-manager/all-files?file_module=Gallery`;
    data["method"] = "GET";
    data["token"] = this.cookieService.get("Auth");
    return this.http.post(this.roasterUrl, data);
  }
  ...
  getMrOrdersCoffeeExperience(roaster_id: any, order_id: any) {
    ...
    data[
      "api_call"
    ] = `/ro/${roaster_id}/mr-orders/${order_id}/coffee-experience`;
    data["method"] = "GET";
    data["token"] = this.cookieService.get("Auth");
    return this.http.post(this.roasterUrl, data);
  }
  ...
  getHrcOrdersCoffeeExperience(roaster_id: any, order_id: any) {
    ...
    data[
      "api_call"
    ] = `/ro/${roaster_id}/hr-orders/${order_id}/coffee-experience`;
    data["method"] = "GET";
    data["token"] = this.cookieService.get("Auth");
    return this.http.post(this.roasterUrl, data);
  }
  postHrcOrdersCoffeeExperience(roaster_id: any, order_id: any, body: any) {
    ...
    data[
      "api_call"
    ] = `/ro/${roaster_id}/hrc-orders/${order_id}/coffee-experience`;
    data["method"] = "POST";
    data["data"] = body;
    data["token"] = this.cookieService.get("Auth");
    return this.http.post(this.roasterUrl, data);
  ...
  getProcessDetails(roasterId: any, harvest_id: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roasterId + "/harvests/" + harvest_id + "/milling";
    data["token"] = this.cookieService.get("Auth");
    return this.http.post(this.roasterUrl, data);
  }
  ...
  updateCuppingType(cupping_report_id: any, body: any): Observable<any> {
    ...
    data[
      "api_call"
    ] = `​/ro/${roaster_id}​/cupping-process​/${cupping_report_id}​/cupping-type`;
    data["token"] = this.cookieService.get("Auth");
    data["method"] = "PUT";
    data["data"] = body;
    return this.http.post(this.roasterUrl, data);
  ...
  addEvaluators(cupping_report_id: any, body: any) {
    ...
    data[
      "api_call"
    ] = `​/ro/${roaster_id}​/cupping-process​/${cupping_report_id}​/evaluators`;
    data["token"] = this.cookieService.get("Auth");
    data["data"] = body;
    data["method"] = "POST";
    return this.http.post(this.roasterUrl, data);
  ...
  addRequestSample(roasterId: any, harvest_id: any, body: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roasterId + "/availability/" + harvest_id + "/request-sample";
    data["token"] = this.cookieService.get("Auth");
    data["method"] = "POST";
    data["data"] = body;
    return this.http.post(this.roasterUrl, data);
  ...
  viewGcOrderDocuments(roasterId: any, order_id: any) {
    var data = {};
    data["api_call"] =
      "/ro/" + roasterId + "/orders/" + order_id + "/documents";
    data["method"] = "GET";
    data["token"] = this.cookieService.get("Auth");
    return this.http.post(this.roasterUrl, data);
  }
  ...
  getStats(roaster_id: any, query: any = {}) {
    var data = {};
    data["api_call"] = `/ro/${roaster_id}/stats?sections=${
      query.sections || ""
    }&customer_type=${query.customer_type || ""}&chart_type=${
      query.chart_type || ""
  ...
  externalRecupSample(roasterId: any, sample_id: any) {
    ...
    data["api_call"] =
      "/ro/" +
      roasterId +
      "/cupping-process​/external-samples/" +
      sample_id +
      "/re-cup";
    data["token"] = this.cookieService.get("Auth");
    data["method"] = "POST";
  ...
  updatePaymentAfterDelivery(roaster_id: any, order_id: any) {
    ...
    data[
      "api_call"
    ] = `/ro/${roaster_id}/mr-orders/${order_id}/payment/after-delivery`;
    data["method"] = "PUT";
    data["token"] = this.cookieService.get("Auth");
    return this.http.post(this.roasterUrl, data);
  }
