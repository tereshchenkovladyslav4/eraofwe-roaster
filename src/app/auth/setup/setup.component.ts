...
export class SetupComponent implements OnInit {
    ...
    personalDetails() {
        ...
        } else if (this.firstname == '' || this.firstname == null || this.firstname == undefined) {
            $('.myAlert-top').show();
        ...
        // }
            ...
            formData.append('api_call', '/invite/users/upload-image');
            formData.append('inviteToken', this.tokenData);

            this.userService.uploadProfileImage(formData).subscribe((response) => {
                ...
                if (response['success'] == true) {
                    ...
                    this.userService.personalDetails(data).subscribe((data) => {
                        if (data['success'] == true) {
                            ...
                            $('.myAlert-top').hide();
                            this.toastrService.success('User details has been added successfully');
    ...
    roasteryDetails() {
        ...
        if (
            ...
            document.getElementById('roaster_name').style.border = '1px solid #D50000';
            document.getElementById('roaster_email').style.border = '1px solid #D50000';
            document.getElementById('roaster_phoneNo').style.border = '1px solid #D50000';
            ...
            document.getElementById('founded_year').style.border = '1px solid #D50000';
            document.getElementById('short_descr').style.border = '1px solid #D50000';
            document.getElementById('vat').style.border = '1px solid #D50000';
            document.getElementById('company_id').style.border = '1px solid #D50000';
            setTimeout(() => {
                this.roasterNameError = '';
                this.roasterEmailError = '';
                this.roasterPhoneError = '';
        ...
        } else if (this.roaster_name == '' || this.roaster_name == null || this.roaster_name == undefined) {
            $('.myAlert-top').show();
        ...
        } else if (this.roaster_phone == '' || this.roaster_phone == null || this.roaster_phone == undefined) {
            $('.myAlert-top').show();
        ...
        //     }
        ...
        } else if (this.website == '' || this.website == null || this.website == undefined) {
            $('.myAlert-top').show();
            ...
            this.userService.roasterDetails(data).subscribe((result) => {
                ...
                if (result['success'] == true) {
                    ...
                    let formData: FormData = new FormData();
                    formData.append('file', blob);
                    formData.append('api_call', '/ro/' + result['result']['roaster_id'] + '/company-image');
                    ...
                    this.userService.uploadProfileImage(formData).subscribe((response) => {
                        ...
                        if (response['success'] == true) {
                            ...
                            this.secondButtonValue = 'Next';
                            $('.myAlert-top').hide();
                            this.toastrService.success('Roaster details has been added successfully');
                            const secondtab = document.getElementById('second-tab');
                    ...
                    if (result['messages']['email'] !== undefined) {
                        ...
                        this.toastrService.error("Please provide valid website URL. ex:'abc.com'.");
                    } else {
