...
export class RequestsTableComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    $(document).ready(function () {
      ...
      for (var x = 0; x < pLen; x++) {
        ...
        if (newliLen > 5) {
          for (var i = 1; i <= 5; i++) {
            var li =
              '<li class="responsive-pagination-list__item">' + i + "</li>";
            $(".pagination-content")
              .eq(x)
    ...
    $("body").on("click", ".responsive-pagination__next", function () {
      ...
      $(this)
        ...
        .find(".responsive-pagination__prev")
        .removeClass("disable");
    ...
    $("body").on("click", ".responsive-pagination__prev", function () {
      ...
      if (stepFirst.text() == "1" && stepFirst.hasClass("active")) {
        ...
        $(this)
          .parents(".pagination-content")
          .find(".responsive-pagination__next")
          .removeClass("disable");
      }
    });
  ...
  getMrRequestsData() {
    this.roasterService
      .getMrAvailabilityRequests(this.roasterId)
      .subscribe((data) => {
        console.log(data);
  ...
  toggleStatusMob() {
    ...
    if (this.showStatusMob == false) {
      document.getElementById("status_id_Mob").style.border =
        "1px solid #30855c";
    } else {
      document.getElementById("status_id_Mob").style.border =
        "1px solid #d6d6d6";
