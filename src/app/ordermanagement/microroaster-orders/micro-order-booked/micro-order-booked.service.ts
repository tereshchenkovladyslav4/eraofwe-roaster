...
export class MicroOrderBookedService {
    ...
    viewMrOrderDetails() {
        this.roasterService.getMrGcOrderDetails(this.roasterId, this.bookOrderId).subscribe((res) => {
            if (res['success'] == true) {
    ...
    getMrDetails() {
        this.userService.getMicroDetails(this.roasterId, this.mrDetails.micro_roaster_id).subscribe((res) => {
            if (res['success'] == true) {
    ...
    viewAvailability() {
        this.userService.getGreenCoffeeDetails(this.roasterId, this.mrDetails.harvest_id).subscribe((res) => {
            if (res['success'] == true) {
    ...
    ViewRecentActivity() {
        this.userService.getMrRecentActivity(this.roasterId, this.bookOrderId).subscribe((res) => {
            if (res['success'] == true) {
                console.log(res);
