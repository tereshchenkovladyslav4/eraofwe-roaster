...
export class BookedOrderConfirmationComponent implements OnInit {
    ...
    acceptOrder() {
        ...
        this.roasterService
            .acceptMrConfirmOrder(this.bookDetailService.roasterId, this.bookId, details)
            .subscribe((res) => {
                if (res['success'] == true) {
    ...
    rejectOrder() {
        ...
        this.roasterService.rejectBookedOrder(this.bookDetailService.roasterId, this.bookId, data).subscribe((res) => {
            if (res['success'] == true) {
