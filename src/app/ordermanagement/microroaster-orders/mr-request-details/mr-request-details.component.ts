...
export class MrRequestDetailsComponent implements OnInit {
    ...
    getRequestDetails(value: any) {
        this.roasterService.getAvailableRequestDetail(this.roaster_id, value).subscribe((data) => {
    ...
    notifyNow() {
        this.roasterService.updateAvailabilityStatus(this.roaster_id, this.request_id, 'approve').subscribe((data) => {
            if (data['success'] == true) {
    ...
    cancelCall() {
        this.roasterService.updateAvailabilityStatus(this.roaster_id, this.request_id, 'reject').subscribe((data) => {
            if (data['success'] == true) {
