...
export class OrderSampleService {
    ...
    viewSampleOrderDetails() {
        this.roasterService.getViewOrderDetails(this.roasterId, this.orderSampleId).subscribe((res) => {
            if (res['success'] == true) {
    ...
    ViewRecentActivity() {
        this.userService.getRecentActivity(this.roasterId, this.orderSampleId).subscribe((res) => {
            if (res['success'] == true) {
                console.log(res);
