...
export class OrderPrebookService {
  ...
  viewPrebookOrderDetails() {
    this.roasterService.getViewOrderDetails(this.roasterId, this.orderPreId).subscribe((res) => {
      if (res['success'] == true) {
  ...
  viewpreEstateDetails() {
    this.userService.getAvailableEstateList(this.roasterId, this.estate_id).subscribe((res) => {
      if (res['success'] == true) {
  ...
  viewpreLotDetails() {
    this.userService.getRoasterLotDetails(this.roasterId, this.estate_id, this.lot_id).subscribe((res) => {
      if (res['success'] == true) {
        this.polygon_id = res['result']['polygon_id'];
  ...
  ViewRecentActivity() {
    this.userService.getRecentActivity(this.roasterId, this.orderPreId).subscribe((res) => {
      if (res['success'] == true) {
        console.log(res);
