...
export class OrderBookedService {
    ...
    viewOrderDetails() {
        this.roasterService.getViewOrderDetails(this.roasterId, this.orderId).subscribe((res) => {
            if (res['success'] == true) {
    ...
    viewAvailability() {
        this.userService.getGreenCoffeeDetails(this.roasterId, this.harvestId).subscribe((res) => {
            if (res['success'] == true) {
                console.log(res);
    ...
    viewEstateDetails(roasterVal: any, esatateVal: any) {
        this.userService.getAvailableEstateList(roasterVal, esatateVal).subscribe((res) => {
            if (res['success'] == true) {
    ...
    ViewRecentActivity() {
        this.userService.getRecentActivity(this.roasterId, this.orderId).subscribe((res) => {
            if (res['success'] == true) {
                console.log(res);
    ...
    getGCOrderDocuments() {
        this.userService.viewGcOrderDocuments(this.roasterId, this.orderId).subscribe((res) => {
            if (res['success'] == true) {
                console.log(res);
