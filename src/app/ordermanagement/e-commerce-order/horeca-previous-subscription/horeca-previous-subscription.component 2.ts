...
@Component({
  selector: 'app-horeca-previous-subscription',
  templateUrl: './horeca-previous-subscription.component.html',
  styleUrls: ['./horeca-previous-subscription.component.css']
})
export class HorecaPreviousSubscriptionComponent implements OnInit {
  ...
  @ViewChild('orderPlacedSample', { static: false }) private orderPlacedSample: ElementRef<HTMLElement>;
	...
	sampleValueToShow: string = "Order Confirmed";
  ...
  constructor(private route: ActivatedRoute,
		...
		public previousSubscriptionService : HorecaPreviousSubscriptionService) { }
  ...
  ngOnInit(): void {
	...
	paySample() {
		...
		this.previousSubscriptionService.receiptShow = true;
		this.previousSubscriptionService.statusPaid = true;
		this.previousSubscriptionService.statusPending = false;
	}
	...
	shipmentStatusSample() {
		...
		this.previousSubscriptionService.statusPaid = true;
		this.previousSubscriptionService.statusPending = false;
		this.previousSubscriptionService.shipment_status = true;
