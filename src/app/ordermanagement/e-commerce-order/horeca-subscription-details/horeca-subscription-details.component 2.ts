...
@Component({
  selector: 'app-horeca-subscription-details',
  templateUrl: './horeca-subscription-details.component.html',
  styleUrls: ['./horeca-subscription-details.component.css']
})
export class HorecaSubscriptionDetailsComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,
		...
		public horecaSubscriptionService : HorecaSubscriptionDetailsService) { }
  ...
  ngOnInit(): void {
	...
	paySample() {
		...
		this.horecaSubscriptionService.receiptShow = true;
		this.horecaSubscriptionService.statusPaid = true;
		this.horecaSubscriptionService.statusPending = false;
	}
	...
	shipmentStatusSample() {
		...
		this.horecaSubscriptionService.statusPaid = true;
		this.horecaSubscriptionService.statusPending = false;
		this.horecaSubscriptionService.shipment_status = true;
