...
export class HorecaOrdersComponent implements OnInit {
    ...
    constructor(public router: Router, public cookieService: CookieService) {
        ...
        this.data = [
            ...
            {
                id: '1001',
                customername: 'Starbucks Coffee',
                dataordered: '21 Jan 2020',
                productname: 'Tres Santos',
                origin: 'Ethopia',
                quantity: '3 bags | 12 oz',
                status: 'New',
            },
            {
                id: '1002',
                customername: 'Finca La Toboba',
            ...
            {
                id: '1003',
                customername: 'La Meridian ',
                dataordered: '24 Apr 2020',
                productname: 'Emporium House..',
                origin: 'Ethopia',
                quantity: '3 bags | 12 oz',
                status: 'Completed',
            },
            ...
            {
                id: '1006',
                customername: 'La Isabela',
                dataordered: '13 Oct 2020',
                productname: 'La Isabela',
                origin: 'Colombia',
                quantity: '5 bags | 20 oz',
                status: 'Active',
            },
    ...
    ngOnInit(): void {
        ...
        this.dtOptions = {
            ...
            columns: [
                ...
                {
                    title:
                        '<label class="bestate-check "><input type="checkbox"  name="estate_all" [checked]="isAllCheckedEstate()" (change)="checkAllEstate($event)"><span class="estatecheckmark"></span></label>',
