...
@Component({
    ...
    templateUrl: './sourcing-order-chat.component.html',
    styleUrls: ['./sourcing-order-chat.component.scss'],
})
export class SourcingOrderChatComponent implements OnInit {
    ...
    ngAfterViewInit() {
                    ...
                    filesInput.addEventListener('change', function (event) {
                        ...
                        for (var i = 0; i < files[0].length; i++) {
                            ...
                            picReader.addEventListener('load', function (event) {
                                ...
                                sd =
                                    "<img class='thumbnail chat-images' src='" +
                                    picFile.result +
                                    "'" +
                                    "title='" +
                                    picFile[0].name +
        ...
        $('body').on('click', '.send-message__btn', function () {
            ...
            if (ChatText !== '' && ChatImg !== '') {
                var message =
                    '<div class="main-message message-from"><div class="main-message__profile clearfix"><div class="float-left img"><img src="../images/dispute-order/profile.png"></div><div class="profile-name"><div class="float-left"><h4 class="name">Finca La Pampa</h4><span class="status">Facilitator</span></div></div></div><div class="message-info"><div class="message-info__body position-relative"><span class="live-time">' +
                    strTime +
                    '</span><div class="message-info__img">' +
                    sd +
