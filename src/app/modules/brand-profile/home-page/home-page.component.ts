...
export class HomePageComponent implements OnInit {
    ...
    saveHomeProfile() {
        ...
        if (
            ...
            this.wizard_title === '' ||
            this.wizard_heading === '' ||
            this.traceability_title === '' ||
            this.traceability_heading === '' ||
            this.substainability_title === '' ||
            this.substainability_heading === ''
        ) {
            ...
            this.userService.updateHomeDetails(this.roaster_id, data, 'home-page').subscribe((res) => {
                if (res['success'] === true) {
