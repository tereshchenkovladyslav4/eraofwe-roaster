...
// PAGE DESCRIPTION : This page contains functions of Add Member.
...
export class AddMembersComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        //              as route params of the selected user and triggers the edit Flag
        ...
        setTimeout(() => {
            if (this.route.snapshot.queryParams['userID']) {
                ...
                this._userService.getRoasterUserData(this.roaster_id, this.userID).subscribe((result) => {
                    if (result['success'] == true) {
                        ...
                        this.roasterService.getUserBasedRoles(this.roaster_id, this.userID).subscribe((data) => {
    ...
    // Function Name : Roles List
    // Description: This function helps to get the all Roles of the user and get Role ID from manage role as route params.

    listRoles() {
        this.roasterService.getRoles(this.roaster_id).subscribe((response) => {
    ...
    // Function Name : Add & Edit Member
    // Description: This function helps to add new member with roles and edit selected member.

    sendInvites() {
        if (this.member_first_name == '' || this.member_first_name == null || this.member_first_name == undefined) {
            this.memberFirstNameError = 'Please enter your member name';
            document.getElementById('member_first_name').style.border = '1px solid #D50000';
            setTimeout(() => {
                this.memberFirstNameError = '';
            }, 4000);
            ...
            document.getElementById('member_last_name').style.border = '1px solid #D50000';
            setTimeout(() => {
            ...
            this.memberEmailError = 'Please enter your member email';
            document.getElementById('member_email').style.border = '1px solid #D50000';
            setTimeout(() => {
                this.memberEmailError = '';
            }, 4000);
        } else if (!this.member_email.match(this.emailFormat)) {
            ...
            (this.member_password == '' || this.member_password == null || this.member_password == undefined) &&
            this.editFlag == 'add'
        ) {
            this.memberPasswordError = 'Please enter your member Password';
            document.getElementById('member_password').style.border = '1px solid #D50000';
            setTimeout(() => {
            ...
            (this.member_confirm_password == '' ||
                this.member_confirm_password == null ||
                this.member_confirm_password == undefined) &&
            this.editFlag == 'add'
        ) {
            this.memberConfirmPasswordError = 'Please enter your password again';
            document.getElementById('member_confirm_password').style.border = '1px solid #D50000';
            setTimeout(() => {
            ...
            document.getElementById('confirmPassword').style.border = '1px solid #D50000';
            setTimeout(() => {
                this.memberConfirmPasswordError = '';
            }, 2000);
        } else {
            ...
            if (this.editFlag == 'add') {
                this._userService.addUserRoaster(data).subscribe((result) => {
                    console.log(result);
                    if (result['success'] == true) {
                        this.loginButtonValue = 'Add user';
                        console.log(result);
                        ...
                        this.roasterService
                            .assignUserBasedUserRoles(this.roaster_id, this.role_id, result['result']['user_id'])
                            .subscribe((data) => {
                                console.log('role isssssssss', JSON.stringify(data));
                                if (data['success'] == true) {
                                    this.toastrService.success(
                                        'Role has been assgined to ' +
                ...
                this._userService.updateUserData(update_data, this.roaster_id, this.userID).subscribe((data) => {
                    ...
                    if (data['success'] == true) {
                        ...
                        if (this.edit_roleList.some((item) => item.id == this.role_id)) {
                            ...
                            this.roasterService
                                .assignUserBasedUserRoles(this.roaster_id, this.role_id, this.userID)
                                .subscribe((response) => {
    ...
    // Function Name : Role selection
    // Description: This function helps to select the role.
