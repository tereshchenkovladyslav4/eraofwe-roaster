...
export class InviteMemberComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        //   </div>
        //     <span class="member-delete-rows fnt-muli fnt-700 text-clr60b">
        // 		Delete row
        // 	</span>
        // 	</div>
    ...
    public sendInvites() {
        ...
        if (flag) {
            ...
            this.addUser.forEach((element) => {
                this.userService.addUserRoaster(element).subscribe((data) => {
                    if (data['success'] == true) {
                        ...
                        this.roasterService
                            .assignUserBasedUserRoles(this.roaster_id, this.role_id, data['result']['user_id'])
                            .subscribe((data) => {
                                if (data['success'] == true) {
