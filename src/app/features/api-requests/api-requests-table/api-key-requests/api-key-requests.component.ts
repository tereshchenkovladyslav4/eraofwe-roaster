...
export class ApiKeyRequestsComponent implements OnInit {
  ...
  roasterterm: any;
	...
	constructor(public router: Router,
		...
		this.data =
			[
			{ requestedBy: 'Third wave coffee roasters',  customerType: 'Micro-Roaster', daterequested: '21 Jan 2020'},
			{ requestedBy: 'Home brew coffee',  customerType: 'HoReCa', daterequested: '22 Apr 2020'},
			{ requestedBy: 'La Barista',  customerType: 'Micro-Roaster', daterequested: '24 Apr 2020'},
			{ requestedBy: 'BRU coffee roastes',  customerType: 'HoReCa', daterequested: '25 May 2020' },
			{ requestedBy: 'La Barista',  customerType: 'Micro-Roaster', daterequested: '26 May 2020'},
			{ requestedBy: 'Blue Tokai roasters',  customerType: 'HoReCa', daterequested: '13 Oct 2020'},
			{ requestedBy: 'Third wave coffee roasters',  customerType: 'HoReCa', daterequested: '13 Dec 2020'},
			{ requestedBy: 'Home brew coffee',  customerType: 'Micro-Roaster', daterequested: '13 Jan 2019'},
			{ requestedBy: 'La Barista',  customerType: 'HoReCa', daterequested: '14 Feb 2019' },
			{ requestedBy: 'Third wave coffee roasters',  customerType: 'Micro-Roaster', daterequested: '14 Jun 2019'}
			];
	...
	setOrigin(origindata: any) {
		...
		this.datatableElement.dtInstance.then(table => {
			table.column(1).search(origindata).draw();
		});
	}
