...
export class OtherCuppingServiceComponent implements OnInit {
        ...
        this.roasterService.listCuppingRequest(this.fc_id).subscribe((res) => {
            ...
            if (this.cuppingService.otherReportDetails) {
                let eachServiceValue = this.mainData.filter(
                    (ele) => ele.cupping_report_id == this.cuppingService.otherReportDetails['cupping_report_id'],
                );
    ...
    evaluatorsList() {
        if (this.cuppingService.otherReportDetails) {
            ...
            this.roasterService.getEvaluatorsList(this.fc_id, this.cupping_report_id).subscribe((response) => {
    ...
    getCuppingScoreDetails() {
        if (this.cuppingService.otherReportDetails) {
            this.cupping_report_id = this.cuppingService.otherReportDetails.cupping_report_id;
            this.userService
                .getCuppingScore(this.fc_id, this.cupping_report_id, this.evaluatorIdArray)
                .subscribe((res) => {
                    if (res['success'] == true) {
    ...
    physicalDefectsList() {
        if (this.cuppingService.otherReportDetails) {
            this.cupping_report_id = this.cuppingService.otherReportDetails.cupping_report_id;
            this.userService.getPhysicalDefectsList(this.fc_id, this.cupping_report_id).subscribe((res) => {
                if (res['success'] == true) {
    ...
    singleCuppingData() {
        if (this.cuppingService.otherReportDetails) {
            this.cupping_report_id = this.cuppingService.otherReportDetails.cupping_report_id;
            this.userService.getSingleCuppingDetails(this.fc_id, this.cupping_report_id).subscribe((data) => {
    ...
    OtherRecupSample() {
        ...
        this.userService.externalRecupSample(this.fc_id, this.sample_id).subscribe((res) => {
            if (res['success'] == true) {
