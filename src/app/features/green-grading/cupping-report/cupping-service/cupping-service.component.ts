...
export class CuppingServiceComponent implements OnInit {
    ...
    constructor(
        ...
        public cuppingService: CuppingReportService,
        private router: Router,
        public yourService: YourServicesService,
    ...
    ViewCuppingInviteList() {
        this.yourService.getCuppingInviteList().subscribe((res) => {
            ...
            if (this.cuppingService.serviceReportDetails) {
                let eachServiceValue = this.mainData.filter(
                    (ele) => ele.cupping_report_id == this.cuppingService.serviceReportDetails['cupping_report_id'],
                );
    ...
    evaluatorsList() {
        if (this.cuppingService.serviceReportDetails) {
            ...
            this.roasterService.getEvaluatorsList(this.ro_id, this.cupping_report_id).subscribe((response) => {
    ...
    getCuppingScoreDetails() {
        if (this.cuppingService.serviceReportDetails) {
            ...
            this.userService
                .getCuppingScore(this.ro_id, this.cupping_report_id, this.evaluator_ids)
                .subscribe((res) => {
                    if (res['success'] == true) {
    ...
    physicalDefectsList() {
        if (this.cuppingService.serviceReportDetails) {
            this.cupping_report_id = this.cuppingService.serviceReportDetails.cupping_report_id;
            this.userService.getPhysicalDefectsList(this.ro_id, this.cupping_report_id).subscribe((res) => {
                if (res['success'] == true) {
    ...
    singleCuppingData() {
        if (this.cuppingService.serviceReportDetails) {
            this.cupping_report_id = this.cuppingService.serviceReportDetails.cupping_report_id;
            this.userService.getSingleCuppingDetails(this.ro_id, this.cupping_report_id).subscribe((data) => {
    ...
    viewProcessDetails() {
        if (this.eachServiceData.harvest_id) {
            ...
            this.userService.getProcessDetails(this.ro_id, this.harvest_id).subscribe((res) => {
                if (res['success'] == true) {
                    console.log(res);
    ...
    reCupSample() {
        if (this.cuppingService.serviceReportDetails) {
            ...
            this.userService.recupSample(this.ro_id, this.service_request_id).subscribe((res) => {
                if (res['success'] == true) {
