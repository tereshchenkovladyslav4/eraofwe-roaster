...
export class GenerateGreenCoffeeComponent implements OnInit {
    ...
    // }
    evaluatorsList() {
        this.userService.getEvaluatorsList(this.ro_id, this.cupping_report_id).subscribe((response) => {
    ...
    addEvaluators() {
        if (this.selectedValue != '') {
            ...
            this.userService.addEvaluators(this.cupping_report_id, data).subscribe((res) => {
                if (res['success'] == true) {
    ...
    goNext() {
        if (this.cupping == '' || this.sample_size == undefined) {
            ...
            this.userService.updateCuppingType(this.cupping_report_id, data).subscribe((res) => {
                if (res['success']) {
    ...
    deleteEvaluatorData(data: any) {
        ...
        this.roasterService.deleteEvaluator(this.ro_id, this.cupping_report_id, this.evaluatorId).subscribe((res) => {
            if (res['success']) {
