...
export class GenerateCoffeeGradingComponent implements OnInit {
    ...
    getEvaluatorData() {
        ...
        this.userService.getEvaluatorsList(this.roaster_id, this.cupping_id).subscribe((res) => {
            if (res['success'] == true) {
    ...
    goNext() {
        ...
        if (flag) {
            ...
            this.userService.addPhysicalDefects(this.roaster_id, this.cupping_id, data).subscribe((res) => {
                if (res['success'] == true) {
    ...
    physicalDefectsList() {
        this.cupping_id = this.generateService.cuppingDetails.cupping_report_id;
        this.userService.getPhysicalDefectsList(this.roaster_id, this.cupping_id).subscribe((res) => {
            if (res['success'] == true) {
