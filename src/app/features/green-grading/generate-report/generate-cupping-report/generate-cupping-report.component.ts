...
export class GenerateCuppingReportComponent implements OnInit {
    ...
    getEvaluatorData() {
        ...
        this.roasterService.getEvaluatorsList(this.roaster_id, this.cupping_id).subscribe((res) => {
            if (res['success'] == true) {
    ...
    getCupReports() {
        if (this.generateReportService.fromQueryParam == 'ServiceRequest') {
            this.roasterService.listServiceCuppingReports(this.roaster_id, this.gc_order_id).subscribe((res) => {
                if (res['success'] == true) {
            ...
            this.roasterService.listSampleCuppingReports(this.roaster_id, this.sample_request_id).subscribe((res) => {
                if (res['success'] == true) {
                    this.CuppingReports = res['result'];
                } else {
                    this.toastrService.error('Error while getting the cupping reports.');
    ...
    singleCuppingData() {
        if (this.cupping_report_id) {
            this.userService.getSingleCuppingDetails(this.roaster_id, this.cupping_report_id).subscribe((data) => {
    ...
    uploadReport() {
        ...
        this.userService.updateStatus(this.roaster_id, this.cupping_report_id, data).subscribe((res) => {
            if (res['success'] == true) {
    ...
    recupSample() {
        if (this.generateReportService.fromQueryParam == 'ServiceRequest') {
            this.userService.recupSample(this.roaster_id, this.gc_order_id).subscribe((res) => {
                if (res['success'] == true) {
            ...
            this.userService.recupSampleRequest(this.roaster_id, this.sample_request_id).subscribe((res) => {
                if (res['success'] == true) {
                    this.toastrService.success('Recupping has started');
