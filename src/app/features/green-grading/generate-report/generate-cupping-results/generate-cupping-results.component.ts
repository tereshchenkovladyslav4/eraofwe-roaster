...
export class GenerateCuppingResultsComponent implements OnInit {
    ...
    getEvaluators() {
        this.roasterService.getEvaluatorsList(this.roaster_id, this.cupping_report_id).subscribe((res) => {
            if (res['success'] == true) {
    ...
    getCuppingScore() {
        ...
        this.userService
            .getCuppingScore(this.roaster_id, this.cupping_report_id, this.evaluator_ids)
            .subscribe((data) => {
