...
export class GradeSampleComponent implements OnInit {
    ...
    addExternalReport() {
        if (
            this.grade_origin === undefined ||
            this.grade_species === undefined ||
            this.grade_estate === undefined ||
            ...
            this.userService.addExternalCuppingReport(this.roaster_id, data).subscribe((res) => {
                if (res['success'] == true) {
    ...
    getExternalReports() {
        this.userService.listCuppingRequest(this.roaster_id).subscribe((data) => {
    ...
    saveExternalSample(editId: any) {
        ...
        this.roasterService.updateExternalSample(this.roaster_id, editId, updateSample).subscribe((result) => {
    ...
    deleteSample(delId: any) {
        console.log(delId);
        this.roasterService.deleteExternalSample(this.roaster_id, delId).subscribe((result) => {
            if (result['success'] == true) {
