...
@Component({
  selector: 'app-cupping-results',
  templateUrl: './cupping-results.component.html',
  styleUrls: ['./cupping-results.component.css']
})
export class CuppingResultsComponent implements OnInit {
  type:boolean;
