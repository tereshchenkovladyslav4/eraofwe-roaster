...
@Component({
    selector: 'app-horeca-agreements',
    templateUrl: './horeca-agreements.component.html',
    styleUrls: ['./horeca-agreements.component.css'],
})
export class HorecaAgreementsComponent implements OnInit {
    ...
    getHorecaList() {
        this.roasterService.getMicroRoastersHoreca(this.roasterId).subscribe((res) => {
            if (res['success'] == true) {
