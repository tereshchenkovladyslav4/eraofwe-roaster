...
export class CofeeExpeienceDetailsComponent implements OnInit {
    ...
    constructor(
        ...
        if (
            this.route.snapshot.queryParams['type'] != undefined &&
    ...
    getMrOrdersCoffeeExperience() {
        this.userService.getMrOrdersCoffeeExperience(this.roaster_id, this.order_id).subscribe((response) => {
    ...
    getHrcOrdersCoffeeExperience() {
        this.userService.getHrcOrdersCoffeeExperience(this.roaster_id, this.order_id).subscribe((response) => {
            if (response['success'] == true) {
                this.website = response['result'].website;
                this.description = response['result'].description;
                this.image_id = response['result'].image_id;
    ...
    saveDefaultSetting() {
        if (
            ...
            if (this.order_type == 'mr') {
                this.userService
                    .postMrOrdersCoffeeExperience(this.roaster_id, this.order_id, data)
                    .subscribe((response) => {
                        if (response['success'] == true) {
            ...
            if (this.order_type == 'hrc') {
                this.userService
                    .postHrcOrdersCoffeeExperience(this.roaster_id, this.order_id, data)
                    .subscribe((response) => {
                        if (response['success'] == true) {
                            this.toastrService.success('The Horeca order details updated Successfully');
                            this.getHrcOrdersCoffeeExperience();
