...
export class ProfileEditComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.userService.getRoasterProfile(this.roaster_id).subscribe((response) => {
            if (response['success'] == true) {
                ...
                this.roasterService
                    .getUserBasedRoles(this.roaster_id, response['result']['id'])
                    .subscribe((roleData) => {
    ...
    profileSave() {
        ...
        if (this.name == '' && this.email == '' && this.phoneno == null && this.role == '') {
            $('.myAlert-top').show();
            ...
            document.getElementById('phone').style.border = '1px solid #D50000';
        ...
        // }
            ...
            console.log(data);
            this.userService.updateRoasterProfile(this.roaster_id, data).subscribe((result) => {
                console.log(result);
